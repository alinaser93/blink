-- =====================================================================
--  سلّـة — RESET + CREATE (سكيمة بلينكِت)
--  ⚠️  تحذير: يمسح الجداول المذكورة وكل بياناتها ثم يبني سكيمة بلينكِت.
--  للاستخدام على قاعدة بيانات تطوير/نموذج أوّلي.
-- =====================================================================
drop table if exists public.order_items cascade;
drop table if exists public.orders      cascade;
drop table if exists public.products    cascade;
drop table if exists public.categories  cascade;
drop table if exists public.customers   cascade;   -- من سكيمة قديمة محتملة
drop table if exists public.riders      cascade;   -- من سكيمة قديمة محتملة
