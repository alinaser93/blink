...
export const CAT_ICON = {
  // أقسام بتصنيف Blinkit (Departments)
  "البقالة والمطبخ": "Wheat", "السناكس والمشروبات": "Popcorn", "الجمال والعناية الشخصية": "Droplet",
  "أساسيات المنزل": "Package", "إلكترونيات ومستلزمات": "Package",
  // أسماء أقسام سابقة (توافق خلفي)
  ...
  "العناية والجمال": "Droplet",
};
export const CAT_ACCENT = {
  // أقسام بتصنيف Blinkit (Departments)
  "البقالة والمطبخ": "#0C831F", "السناكس والمشروبات": "#E0A21F", "الجمال والعناية الشخصية": "#C2477F",
  "أساسيات المنزل": "#2B7A9B", "إلكترونيات ومستلزمات": "#4A4F8C",
  // أسماء أقسام سابقة (توافق خلفي)
